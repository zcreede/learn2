...
public class ClinitemUseLog extends BaseEntity {
   ...
   @Excel(
      name = "修改时间(根据最迟时间，可以建立服务批量更新)",
      width = (double)30.0F,
      dateFormat = "yyyy-MM-dd"
   )
   private Date altDate;

   public ClinitemUseLog() {
   }

   public ClinitemUseLog(String hospitalCode, String docCd, String itemClassCd) {
