...
public class MedicareAuditEncounterDtosReq {
   ...
   private String fsi_operation_dtos;
   ...
   public String getFsi_operation_dtos() {
      return this.fsi_operation_dtos;
   }

   public void setFsi_operation_dtos(String fsi_operation_dtos) {
