...
public class EmrQcFlowStatis extends BaseEntity {
   @JsonFormat(
   ...
   private Integer flow5;
   @Excel(
      name = "已确认有误"
   )
   private Integer flow6;
   @Excel(
      name = "病历删除"
   )
   private Integer flow7;
   @Excel(
      name = "缺陷病历数"
   )
   ...
   private Integer ryjlTotal;
   private Integer bcjlTotal;
   private Integer ssjlTotal;
   private Integer sszqtysTotal;
   private Integer cyjlTotal;
   private Integer gdblTotal;
   ...
   public Integer getFlow7() {
      return this.flow7;
   }

   public void setFlow7(Integer flow7) {
      this.flow7 = flow7;
   }
   ...
   public Integer getFlow5() {
      return this.flow5;
   }

   public void setFlow5(Integer flow5) {
      this.flow5 = flow5;
   }

   public Integer getFlow6() {
      return this.flow6;
   }

   public void setFlow6(Integer flow6) {
      this.flow6 = flow6;
   }

   public Integer getRyjlTotal() {
      return this.ryjlTotal;
   }

   public void setRyjlTotal(Integer ryjlTotal) {
      this.ryjlTotal = ryjlTotal;
   }

   public Integer getBcjlTotal() {
      return this.bcjlTotal;
   }

   public void setBcjlTotal(Integer bcjlTotal) {
      this.bcjlTotal = bcjlTotal;
   }

   public Integer getSsjlTotal() {
      return this.ssjlTotal;
   }

   public void setSsjlTotal(Integer ssjlTotal) {
      this.ssjlTotal = ssjlTotal;
   }

   public Integer getSszqtysTotal() {
      return this.sszqtysTotal;
   }

   public void setSszqtysTotal(Integer sszqtysTotal) {
      this.sszqtysTotal = sszqtysTotal;
   }

   public Integer getCyjlTotal() {
      return this.cyjlTotal;
   }

   public void setCyjlTotal(Integer cyjlTotal) {
      this.cyjlTotal = cyjlTotal;
   }

   public Integer getGdblTotal() {
      return this.gdblTotal;
   }

   public void setGdblTotal(Integer gdblTotal) {
      this.gdblTotal = gdblTotal;
   }
