...
public class ElemSign extends BaseEntity {
   ...
   @Excel(
      name = "签名类型 11 医生签名 12 患者签名"
   )
   private String signTypeCd;
   @Excel(
      name = "创建人名称"
   )
   ...
   public ElemSign(String contElemName, Long elemId, String elemName, String elemCd, String typeFlag, String contType, String signTypeCd) {
   ...
   public void setSignTypeCd(String signTypeCd) {
      this.signTypeCd = signTypeCd;
   }

   public String getSignTypeCd() {
      return this.signTypeCd;
   }
   ...
   public String toString() {
      return (new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)).append("id", this.getId()).append("tempId", this.getTempId()).append("tempName", this.getTempName()).append("tempType", this.getTempType()).append("contElemName", this.getContElemName()).append("elemId", this.getElemId()).append("elemName", this.getElemName()).append("elemCd", this.getElemCd()).append("typeFlag", this.getTypeFlag()).append("contType", this.getContType()).append("signTypeCd", this.getSignTypeCd()).append("crePerName", this.getCrePerName()).append("crePerCode", this.getCrePerCode()).append("altPerName", this.getAltPerName()).append("altDate", this.getAltDate()).toString();
   }
}
