...
public class TmplQuoteElem extends BaseEntity {
   ...
   public TmplQuoteElem() {
   }

   public TmplQuoteElem(String contElemName, Long elemId, String elemName, String elemCd, String typeFlag, String contType) {
