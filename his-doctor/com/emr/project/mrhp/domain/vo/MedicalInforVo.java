...
public class MedicalInforVo implements Serializable {
   @ApiModelProperty(
   ...
   private Integer invasive_ventilator_d;
   @ApiModelProperty("有创呼吸机使用时间-小时")
   private Integer invasive_ventilator_h;
   @ApiModelProperty("有创呼吸机使用时间-分钟")
   private Integer invasive_ventilator_mi;
   ...
   public Integer getInvasive_ventilator_d() {
      return this.invasive_ventilator_d;
   }

   public void setInvasive_ventilator_d(Integer invasive_ventilator_d) {
      this.invasive_ventilator_d = invasive_ventilator_d;
   }

   public Integer getInvasive_ventilator_h() {
      return this.invasive_ventilator_h;
   }

   public void setInvasive_ventilator_h(Integer invasive_ventilator_h) {
      this.invasive_ventilator_h = invasive_ventilator_h;
   }

   public Integer getInvasive_ventilator_mi() {
      return this.invasive_ventilator_mi;
   }

   public void setInvasive_ventilator_mi(Integer invasive_ventilator_mi) {
