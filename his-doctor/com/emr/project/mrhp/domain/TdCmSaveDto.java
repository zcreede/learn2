...
public class TdCmSaveDto {
   @ApiModelProperty("诊断信息")
   private List tdCmDiagSaveList;
   @ApiModelProperty("手术信息")
   private List tdCmOperSaveList;
   @ApiModelProperty("重症信息")
   private List tdCmIcuSaveList;
   @ApiModelProperty(
      hidden = true
   )
   ...
   private Long med_prep_flag;
   @ApiModelProperty("使用中医诊疗设备标志")
   private Long cm_equi_flag;
   @ApiModelProperty("使用中医诊疗技术标志")
   private Long cm_tech_flag;
   @ApiModelProperty("辩证施护标志")
   private Long plead_flag;
   @ApiModelProperty("药物过敏标志")
   private Long drug_alle_flag;
   ...
   public Long getAge_y() {
      return this.age_y;
   }

   public void setAge_y(Long age_y) {
      this.age_y = age_y;
   }

   public Long getAge_m() {
      return this.age_m;
   }

   public void setAge_m(Long age_m) {
      this.age_m = age_m;
   }

   public Long getAge_d() {
      return this.age_d;
   }

   public void setAge_d(Long age_d) {
      this.age_d = age_d;
   }

   public Long getAge_h() {
      return this.age_h;
   }

   public void setAge_h(Long age_h) {
      this.age_h = age_h;
   }

   public Long getAge_mi() {
      return this.age_mi;
   }

   public void setAge_mi(Long age_mi) {
      this.age_mi = age_mi;
   }
   ...
   public Long getMed_prep_flag() {
      return this.med_prep_flag;
   }

   public void setMed_prep_flag(Long med_prep_flag) {
      this.med_prep_flag = med_prep_flag;
   }

   public Long getCm_equi_flag() {
      return this.cm_equi_flag;
   }

   public void setCm_equi_flag(Long cm_equi_flag) {
      this.cm_equi_flag = cm_equi_flag;
   }

   public Long getCm_tech_flag() {
      return this.cm_tech_flag;
   }

   public void setCm_tech_flag(Long cm_tech_flag) {
      this.cm_tech_flag = cm_tech_flag;
   }

   public Long getPlead_flag() {
      return this.plead_flag;
   }

   public void setPlead_flag(Long plead_flag) {
      this.plead_flag = plead_flag;
   }

   public Long getDrug_alle_flag() {
      return this.drug_alle_flag;
   }

   public void setDrug_alle_flag(Long drug_alle_flag) {
   ...
   public Long getOut_in_flag() {
      return this.out_in_flag;
   }

   public void setOut_in_flag(Long out_in_flag) {
   ...
   public List getTdCmDiagSaveList() {
      return this.tdCmDiagSaveList;
   }

   public void setTdCmDiagSaveList(List tdCmDiagSaveList) {
      this.tdCmDiagSaveList = tdCmDiagSaveList;
   }

   public List getTdCmOperSaveList() {
      return this.tdCmOperSaveList;
   }

   public void setTdCmOperSaveList(List tdCmOperSaveList) {
      this.tdCmOperSaveList = tdCmOperSaveList;
   }

   public List getTdCmIcuSaveList() {
      return this.tdCmIcuSaveList;
   }

   public void setTdCmIcuSaveList(List tdCmIcuSaveList) {
      this.tdCmIcuSaveList = tdCmIcuSaveList;
   }
